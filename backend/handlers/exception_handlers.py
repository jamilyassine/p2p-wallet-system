...
def register_exception_handlers(app: FastAPI):
    ...
    async def transfer_not_found_handler(request: Request, exc: TransferNotFoundException):
        return JSONResponse(
            status_code=404,
    ...
    async def invalid_amount_handler(request: Request, exc: InvalidTransferAmountException):
        return JSONResponse(
            status_code=400,
    ...
    async def self_transfer_handler(request: Request, exc: SelfTransferException):
        return JSONResponse(
            status_code=400,
